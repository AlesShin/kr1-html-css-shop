...
- `js/main.js` — JavaScript для формы и модального окна;
...
ФИО: Шиншин Алексей Антонович

Группа: ЭФБО-02-25

## Текущий статус

Добавлена форма заявки, модальное окно и базовая валидация.

## GitHub Pages

[Открыть опубликованный сайт](https://alesshin.github.io/kr1-html-css-shop/)
